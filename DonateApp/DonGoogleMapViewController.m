...
-(void)positionMarkers{
    ...
    for (DONItem * eachItem in self.itemsOnMap) {
        ...
        [catQ findObjectsInBackgroundWithBlock:^(NSArray * _Nullable objects, NSError * _Nullable error) {
            ...
            UIImage *localIconImage = [self imageByDrawingWhiteCircleBehindImage:[UIImage imageNamed:[NSString stringWithFormat:@"%@.png",category.name]] andResizingToSize:CGSizeMake(39, 39) withColor:[UIColor whiteColor]];
